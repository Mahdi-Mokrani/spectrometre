...
>Le _spectromètre_, comme son nom l'indique, est l'instrument qui permet de _décomposer_ le faisceau lumineux issu d'une source, considéré comme un _mélange_ de lumières colorées, dans l'ensemble décomposé des lumières colorées _pures_ qui constituent son spectre, et d'obtenir une _mesure_  de leurs longueurs d'onde. 
